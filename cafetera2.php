...
<body>
	...
	<div class="contenedor-grid" id="menu">
		...
		<div class="elemento-grid" id="dpreparar">
			<input type="submit" name="preparar" id="preparar"  value="s" style="display:none;" alt="reponer">
			<input src="./img/preparar.png" alt="Preparar caf�" type="image" height="64" width="64" onclick="document.getElementById('preparar').click()" alt="reponer">
		</div>
