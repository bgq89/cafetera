...
<body>
	...
	<div class="contenedor-grid" id="menu">
		...
		<div class="elemento-grid" id="dpreparar">
			<input name="preparar" id="preparar" type="submit" value="s" style="display:none;">
		...
		<div class="elemento-grid" id="dreponer">
			<input name="reponer" id="reponer" type="submit" value="s" style="display:none;">
		...
		<div class="elemento-grid" id="dborrar">
			<input type="reset" id="borrar" style="display:none;">
			<img src="./img/borrar.png" alt="Borrar selecci�n" height="64" width="64" onclick="document.getElementById('borrar').click()">
		</div>
		<!-- /BOTONES -->
	</div>
	</form>
